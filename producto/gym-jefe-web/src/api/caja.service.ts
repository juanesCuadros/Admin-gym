...
export const cajaService = {
  ...
  async registrarVenta(data: RegistrarVentaRequest, idempotencyKey: string): Promise<VentaResponseDto> {
  ...
  async registrarPagoMembresia(data: RegistrarPagoMembresiaRequest, idempotencyKey: string): Promise<PagoMembresiaResponseDto> {
